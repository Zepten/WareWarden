...
Для запуска WireWarden необходимы `Docker` и `Docker Compose`. Для активации виртуального окружения Python в целях удобства разработки следует установить `Python` и `Poetry`.
